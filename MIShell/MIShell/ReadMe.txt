========================================================================
    ACTIVE TEMPLATE LIBRARY : MIShell Project Overview
========================================================================

AppWizard has created this MIShell project for you to use as the starting point for
...
MIShell.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (MIShell.h)
        GUID definitions                                (MIShell_i.c)
        A type library                                  (MIShell.tlb)
        Marshaling code                                 (MIShell_p.c and dlldata.c)

MIShell.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in MIShell.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named MIShell.pch and a precompiled types file named StdAfx.obj.
...
MIShellps.vcxproj
	...
	dlldata.c, MIShell_i.c and MIShell_p.c which are required
	to build the proxy/stub DLL.

MIShellps.vcxproj.filters
